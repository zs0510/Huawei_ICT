...
int num_of_nodes, num_of_edges_initial, num_of_operations, num_of_paths, num_of_channels, distance_attenuation_max;
...
//        }
    ...
    for (int pid = 0; pid < num_of_paths; ++pid) {
        auto& path = paths[pid];
        cout << "path.id = " << path.id << ", nid0 = " << path.nid0 << ", nid1 = " << path.nid1 << "\n";
    }
#endif
...
//        cout << "\nedges_new = " << edges_new << endl;
        ...
        if (how_many_seconds() > 90.0) break;
//        break;
    }
